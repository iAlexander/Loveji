...
public class AppIndexingUtil {
    private static final String STICKER_URL_PATTERN = "lovejikisses://sticker/%s";
    private static final String STICKER_PACK_URL_PATTERN = "lovejikisses://sticker/pack/%s";
    private static final String CONTENT_PROVIDER_STICKER_PACK_NAME = "Loveji Kisses Pack";
