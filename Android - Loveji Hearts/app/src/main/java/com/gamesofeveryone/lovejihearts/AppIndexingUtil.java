package com.gamesofeveryone.lovejihearts;
...
public class AppIndexingUtil {
    private static final String STICKER_URL_PATTERN = "lovejihearts://sticker/%s";
    private static final String STICKER_PACK_URL_PATTERN = "lovejihearts://sticker/pack/%s";
    private static final String CONTENT_PROVIDER_STICKER_PACK_NAME = "Loveji Hearts Pack";
